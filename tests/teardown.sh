...
curl -s -XDELETE "$BASE/elastical-test,elastical-test-delete,elastical-test-get,elastical-test-index,elastical-test-refresh,elastical-test-refresh2,elastical-test-putmapping,elastical-test-putmapping2"
