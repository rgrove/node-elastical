...
@method getMapping
@param {Client} client Client instance.
@param {String} name Index name to retrieve the  mapping of.
...
**/
Index.getMapping = function (client, name, type, callback) {
  if(!client||!type||!name||!callback) {
    throw new Error('Invalid parameters');
  }
  client._request('/' + encode(name) + '/' + encode(type) + '/_mapping', {
      method: 'GET'
  }, callback);
}
